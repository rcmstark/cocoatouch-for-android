...
If you are here, I will assume:
  ...
  - You like CocoaTouch
  - You need to code for Android but you don't want to learn it
...
Nice right? But it becomes better. To add a new Activity in the stack:
...
- Select New-> Activity -> Empty Activity
    ...
    - Layout Name: This is partf of your XML id. Example: If you put the name "tutorialcontroller", you id will be R.layout.tutorialcontroller 
    - Click in Finish
...
Android Studio create it in the folder res->laytout. You can edit your canvas and touch in pure XML (I miss you XCODE interfacebuilder...)
